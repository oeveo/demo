            ...
            <header class="navbar" id="top" role="banner">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand nav" id="brand">
                        <a href="/index"><img src="/static/assets/img/logo.png"
                                          alt="brand"></a>
                    </div>
                </div>
...
<#macro paging pageInfo>
        <ul class="pagination">
            <a href="${method}1" class="btn
                    btn-primary">首页</a>&ensp;&ensp;


            <a href="${method}${pageInfo.getPageNum()-1}" class="btn
                    btn-primary">上一页</a>&ensp;&ensp;

            <a href="${method}${pageInfo.getPageNum()+1}" class="btn
                    btn-primary">下一页</a>&ensp;&ensp;


            <a href="${method}${pageInfo.getPages()}" class="btn
                    btn-primary">尾页</a>&ensp;&ensp;

            共有${pageInfo.getPages()}页，${pageInfo.getTotal()}条数据，当前第${pageInfo.getPageNum()}页
        </ul><!-- /.pagination-->
</#macro>