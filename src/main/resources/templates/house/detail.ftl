                        ...
                        <section id="property-gallery">
                            <div class="owl-carousel property-carousel">
                                   <div class="property-slide">
                                      <a href="/static/imgs/house/${house.images}" class="image-popup">
                                         <div class="overlay"><h3>Front View</h3></div>
                                         <img alt="" src="/static/imgs/house/${(house.images)!}">
                                     </a>
                                   </div><!-- /.property-slide -->
                                ...
                                <section id="quick-summary" class="clearfix">
                                    ...
                                    <dl>
                                        <dt>地址</dt>
                                            <dd>${house.address}</dd>
                                        <dt>价格</dt>
                                            <dd><span class="tag price">${house.price}</span>元</dd>
                                        <dt>类型:</dt>
                                            <dd>销售</dd>
                                        <dt>面积:</dt>
                                ...
                                <section id="floor-plans">
                                    <div class="floor-plans">
                                        <header><h2>户型图</h2></header>
                                            <a href="/static/imgs/house/${house.floorPlan}" class="image-popup"><img alt="" src="/static/imgs/house/${house.floorPlan}"></a>
                                    </div>
                                </section><!-- /#floor-plans -->
                            ...
                            <div class="property small">
                                <a href="/house/detail?id=${house.id}">
                                    <div class="property-image">
                                        <img alt="" src="/static/imgs/house/${(house.images)!}" style="width: 100px;height: 75px">
                                    </div>
                                </a>
                                <div class="info">
