                ...
                <section id="sidebar">
                    ...
                    <aside>
                        <ul class="sidebar-navigation">
                            ...
                            <li <#if  pageType != "book">  class="active" </#if> ><a href="/house/ownlist/1"><i class="fa fa-home"></i><span>我的房产信息</span></a></li>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                 ...
                                 <#list houses as house>
                                    <tr>
                                        <td class="image">
                                            <a href="/house/detail?id=${house.id}"><img alt="" src="/static/imgs/house/${(house.images)!}" style="width: 105px;height: 78px"></a>
                                        </td>
                                        <td><div class="inner">
                                            <a href="/house/detail?id=${house.id}"><h2>${house.name}</h2></a>
                                            <figure>${house.address}</figure>
                                            <div class="tag price">${house.price}元</div>
                                        </div>
                                        </td>
                                        <td>${(house.createTime?datetime)}</td>
                                        <td>${(house.remarks)}</td>
                                        <td><#if house.state==1>上架<#else>下架</#if></td>
                                        <td class="actions">
                                            <a href="/house/del?id=${house.id}"><i class="delete fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                 </#list>
                                </tbody>
